...
public class ConfigTest {
    ...
    public void checkConfig() {
        ...
        System.setProperty("QUERY_DEFAULT_LIMIT", "10");
        System.setProperty("QUERY_LIMIT_MAXIMUM", "1000");
        System.setProperty("AGGREGATION_SIZE", "1000");
        ...
        assertEquals(10, Config.getQueryDefaultLimit());
        assertEquals(1000, Config.getQueryLimitMaximum());
        assertEquals(1000, Config.getAggregationSize());
