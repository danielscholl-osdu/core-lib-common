...
public class PersistenceHelperTests {
    ...
    public void should_combineJsonFromStorageWithRecordFromDataStore_when_generatingStringCopyOfTheRecord() {
        ...
        metadata.setKind("slb:test:kind:1.0.0");
        metadata.setAcl(acl);
        ...
        metadata.setModifyUser("user1");
        metadata.setModifyTime(modifyTime);
        metadata.setUser("user");

        JsonObject json = PersistenceHelper.combineRecordMetaDataAndRecord(element, metadata, 123L);
