...
public class Config {
    ...
    @Value("${AGGREGATION_SIZE}")
    private static String AGGREGATION_SIZE;
    ...
    public static int getAggregationSize() {
        String aggregationSize = !Strings.isNullOrEmpty(AGGREGATION_SIZE) ? AGGREGATION_SIZE : getEnvironmentVariable("AGGREGATION_SIZE");
        return Integer.parseInt(getDefaultOrEnvironmentValue(aggregationSize, 1000));
    }
